...
HELP_CATEGORIES = {
    ...
    "supportpanel": {
        ...
        "emoji": "🛎️",
        "description": "แผงปุ่ม 2 ปุ่ม — เรียกแอดมิน / ขอความช่วยเหลือ\n"
        ...
        "commands": [
            ...
            ("/supportpanel setchannel channel:#ห้อง",
             "กำหนดห้องที่รับการแจ้งเตือนจากปุ่มเรียกแอดมิน / ขอความช่วยเหลือ"),
            ("/supportpanel panel",
             "โพสต์แผงปุ่มในห้องที่รันคำสั่ง (ต้องตั้งค่า 3 ขั้นตอนด้านบนให้ครบก่อน)"),
        ],
    },
    "settings": {
        "label": "ตั้งค่าทั่วไป",
